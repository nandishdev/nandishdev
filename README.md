...
👨‍💻 Hi, I'm Nandish K — a developer passionate about AI-powered tools and full-stack web development. I enjoy building systems that bridge machine learning with practical, user-facing products.

🚀 Some things I've built:
- **[Syn2Sem](https://github.com/nandishdev/syntax-to-semantics-syn2sem-)** — an AI-assisted code translation tool that converts code across Java, C, C++, Python, and JavaScript, catching syntax and semantic errors along the way.
- **[AI ContentCraft](https://github.com/nandishdev/ai-contentcraft)** — a multi-modal AI content generation platform built on Google Gemini 2.5 Flash.
